...
public class BarcodeScannerActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        scanBut = (Button)findViewById(R.id.camerascanBut);
        ...
        doneBut.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent passBarcodeBackIntent = new Intent(BarcodeScannerActivity.this, MainActivity.class);
				passBarcodeBackIntent.putExtra("barcode", barcodeStr);
				setResult(RESULT_OK, passBarcodeBackIntent);
				finish();
			}
        });
	}
